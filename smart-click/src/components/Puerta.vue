    ...
    <v-card class="background-card margin-card">
      <v-row class="action-row  action_btn">
          <div class="div-margin">
            <v-btn v-if="open=='closed' " depressed icon class="button-margin" @click="openDoorFunction">
        ...
        <v-row class="action-row  action_btn">
          <div class="div-margin">
            <v-btn v-if="lock=='unlocked' " depressed icon class="button-margin" @click="lockDoorFunction">
